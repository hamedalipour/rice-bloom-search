...
const categoryPages = [
  {
    slug: 'berenj',
    title: 'خرید برنج ایرانی اصل | قیمت روز برنج هاشمی معطر گیلان – ' + SITE,
    description: 'خرید آنلاین برنج ایرانی اصل با قیمت روز؛ برنج هاشمی معطر برداشت تازه از شالیزارهای گیلان و مازندران با ارسال سریع به سراسر ایران.',
  },
  {
    slug: 'chai',
    title: 'خرید چای ایرانی اصل لاهیجان | چای سیاه، بهاره و چوب با قیمت مناسب – ' + SITE,
    description: 'خرید چای ایرانی اصل لاهیجان؛ چای سیاه بهاره و چای چوب شمال (ساقه‌دار)، مستقیم از باغ‌های چای گیلان با بسته‌بندی مطمئن و ارسال سریع.',
  },
];
